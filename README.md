...
In case you need to use multiple configurations for the same Pi-hole instance you can use sections in the configuration file:
...
Configurations where one of the lists contains entries from the other is not officially supported but should work:
